...
Console.Write("Introduce n articulos que deseas vender: "); int tam = int.Parse(Console.ReadLine());
...
for (int i = 0; i < tam; i++) {
    ...
    Console.Write($"Cantidad del articulo {i + 1}: "); int articulo = int.Parse(Console.ReadLine());
    Console.Write($"Precio del articulo {i + 1}: "); int precioart = int.Parse(Console.ReadLine());
