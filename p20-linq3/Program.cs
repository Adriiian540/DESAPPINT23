List<string> frutas = new() {"pera","melon","sandia","durazno","manzana","platano","kiwi","naranja","jicama","papaya","limas","moras","lichis","guamuchiles","chilitos","pitayas","maracuya","xoconostle"};
...
Console.WriteLine("\nFrutas que contienen las letrs an "+anfrutas.Count());
...
Console.WriteLine("\nFrutas que contienen las letrs an "+xz.Count());
xz.ForEach(f=>Console.WriteLine(f+""));